...
export function SiteShell({ children }: { children: React.ReactNode }) {
  ...
  <main>{children}</main><footer className="footer"><div className="footer-grid"><div><Link href="/" className="brand footer-brand"><span className="brand-symbol"><Boxes size={20} strokeWidth={2.2} /></span><span>Tools<span>HUB</span><small>{t("brand.tagline")}</small></span></Link><p>{t("footer.privacy")}</p><p className="footer-credit">{t("footer.credit")}</p></div><div><h3>{t("footer.explore")}</h3><Link href="/tools">{t("nav.tools")}</Link><Link href="/games">{t("nav.games")}</Link><Link href="/ai">{t("nav.ai")}</Link><Link href="/blog">{t("nav.blog")}</Link><Link href="/links">{t("nav.links")} · 2,173</Link></div><div><h3>{t("footer.account")}</h3><Link href="/profile">{t("nav.profile")}</Link><Link href="/my-data">{t("nav.data")}</Link><Link href="/settings">{t("nav.settings")}</Link></div><div><h3>{t("footer.privacyTitle")}</h3><Link href="/privacy">{t("footer.privacy")}</Link></div></div><div className="footer-bottom"><span>{t("footer.credit")}</span><span>{t("footer.updated")} · 15 Aug 2026</span></div></footer></div>;
}
