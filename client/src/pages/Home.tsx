...
export default function Home() {
  ...
  return <div>
    <section className="hero-section" aria-labelledby="home-hero-title"><div className="hero-grid site-frame"><div className="hero-copy"><p className="eyebrow"><span aria-hidden="true">✦ </span>{t("home.eyebrow")}</p><h1 id="home-hero-title"><span>{t("home.titleA")}</span><span>{t("home.titleB")}</span><span className="text-cobalt-light">{t("home.titleC")}</span></h1><p className="hero-description">{t("home.copy")}</p><div className="mt-8 flex flex-wrap gap-3"><Link href="/tools" className="hero-primary-cta"><Wrench className="size-4" aria-hidden="true" />{t("home.tools")}<ArrowRight className="size-4" aria-hidden="true" /></Link><Link href="/games" className="hero-secondary-cta"><Gamepad2 className="size-4" aria-hidden="true" />{t("home.games")}</Link></div><ul className="hero-stats"><li>{t("home.statTools")}</li><li>{t("home.statGames")}</li><li>{t("home.statFree")}</li><li>{t("home.statPrivacy")}</li></ul></div><div className="hero-visual" aria-hidden="true"><WorkshopPlate variant="hero" /><div className="hero-coordinate c1">{t("home.markWork")}</div><div className="hero-coordinate c2">{t("home.markPlay")}</div></div></div></section>
    <section className="site-frame section-space" aria-labelledby="home-featured-title"><div className="section-heading"><div><p className="eyebrow">{t("home.stepTools")}</p><h2 id="home-featured-title">{t("home.featured")}</h2><p>{t("home.featuredCopy")}</p></div><Link href="/tools" className="text-link">{t("home.viewAll")}<ArrowRight className="size-4" aria-hidden="true" /></Link></div><div className="tool-grid featured-grid">{featuredTools.map((tool) => <ToolCard key={tool.slug} tool={tool} compact />)}</div></section>
    ...
    <section className="games-feature" aria-labelledby="home-games-title"><div className="site-frame games-feature-inner"><div className="games-feature-copy"><p className="eyebrow">{t("home.stepPlay")}</p><h2 id="home-games-title">{t("home.gamesTitle")}</h2><p>{t("home.gamesCopy")}</p><Link href="/games" className="dark-cta"><Gamepad2 className="size-4" aria-hidden="true" />{t("home.games")}<ArrowRight className="size-4" aria-hidden="true" /></Link></div><div className="game-showcase" aria-hidden="true"><WorkshopPlate variant="games" /><div className="floating-game-card"><span><Layers3 className="size-4" /></span><strong>{gameRegistry[0].name}</strong><small>{language === "bn" ? gameRegistry[0].genreBn : gameRegistry[0].genre}</small></div><div className="floating-game-card second"><span><Sparkles className="size-4" /></span><strong>{gameRegistry[2].name}</strong><small>{language === "bn" ? gameRegistry[2].genreBn : gameRegistry[2].genre}</small></div></div></div></section>
