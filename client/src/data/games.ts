...
export const games: GameDefinition[] = [
  game("wordle", "Wordle", "words", true), game("word-sprint", "Word Sprint", "words"), game("spelling-bee", "Spelling Bee", "words"), game("anagram", "Anagram", "words"), game("word-search", "Word Search", "words"), game("hangman", "Hangman", "words"), game("typing-race", "Typing Race", "words"), game("letter-stack", "Letter Stack", "words"),
  game("2048", "2048", "puzzle", true), game("sudoku", "Sudoku", "puzzle", true), game("minesweeper", "Minesweeper", "puzzle", true), game("memory-match", "Memory Match", "puzzle", true), game("sliding-puzzle", "Sliding Puzzle", "puzzle"), game("block-puzzle", "Block Puzzle", "puzzle"), game("color-flow", "Color Flow", "puzzle"), game("number-merge", "Number Merge", "puzzle"), game("match-three", "Match Three", "puzzle"), game("maze-runner", "Maze Runner", "puzzle"),
  game("snake", "Snake", "arcade", true), game("tetris", "Tetris", "arcade", true), game("breakout", "Breakout", "arcade"), game("flappy-flight", "Flappy Flight", "arcade"), game("space-dodge", "Space Dodge", "arcade"), game("asteroid-dash", "Asteroid Dash", "arcade"), game("bubble-pop", "Bubble Pop", "arcade"), game("fruit-slice", "Fruit Slice", "arcade"), game("whack-a-mole", "Whack-a-Mole", "arcade"), game("neon-runner", "Neon Runner", "arcade"),
  ...
  game("idle-garden", "Idle Garden", "casual"), game("cozy-cafe", "Cozy Café", "casual"), game("farm-days", "Farm Days", "casual"), game("fishing-trip", "Fishing Trip", "casual"), game("cookie-clicker", "Cookie Clicker", "casual"), game("tower-defense", "Tower Defense", "casual"), game("dice-quest", "Dice Quest", "casual"), game("paper-plane", "Paper Plane", "casual"),
];
