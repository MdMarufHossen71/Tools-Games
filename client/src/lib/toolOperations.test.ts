...
describe("runTool", () => {
  ...
  it("creates bounded email utilities locally without mailbox or deliverability claims", () => {
    expect(runTool("gmail-alias-variations", "hello.world@gmail.com").value).toContain("not new email accounts");
    expect(runTool("email-syntax-advisor", "hello@gmail.con").value).toContain("gmail.com");
    expect(runTool("email-extractor", "Contact hello@toolshub.example twice: hello@toolshub.example").value).toBe("hello@toolshub.example");
    expect(runTool("email-pattern-builder", "Ada\nLovelace\nexample.com").value).toContain("Unverified naming patterns");
    expect(runTool("mailto-link-builder", "hello@toolshub.example\nHello\nWelcome").value).toContain("mailto:hello@toolshub.example?subject=Hello");
    expect(runTool("html-to-text", "<h1>ToolsHUB</h1><script>ignore()</script>").value).toBe("ToolsHUB");
  });
  ...
  it("maps every concrete browser-local processor to a visible unique catalogue route", () => {
    ...
    expect(localOperationSlugs).toHaveLength(73);
  ...
  it("executes every registered operation through a dedicated non-passthrough result", () => {
    const inputFor: Record<string, string> = {
      "word-counter": "ToolsHUB works", "case-converter": "ToolsHUB", "reverse-text": "ToolsHUB", "sort-lines": "z\na", "shuffle-lines": "first\nsecond", "remove-extra-spaces": "ToolsHUB   works", "remove-empty-lines": "ToolsHUB\n\nworks", "remove-duplicates": "ToolsHUB\nToolsHUB", "add-text-to-lines": "#\nToolsHUB", "text-repeater": "2\nToolsHUB", "text-to-binary": "A", "binary-to-text": "01000001", "url-extractor": "Visit https://toolshub.example", "line-numberer": "ToolsHUB", "sentence-counter": "ToolsHUB works.", "find-replace": "o\nx\nToolsHUB", "slug-generator": "ToolsHUB Start", "reading-time": "ToolsHUB works", "gmail-alias-variations": "hello.world@gmail.com", "email-syntax-advisor": "hello@toolshub.example", "email-extractor": "Contact hello@toolshub.example", "email-pattern-builder": "Ada\nLovelace\nexample.com", "mailto-link-builder": "hello@toolshub.example\nHello\nWelcome", "email-size-estimator": "ToolsHUB", "html-to-text": "<p>ToolsHUB</p>", "email-signature-builder": "ToolsHUB\nBuilder\nToolsHUB\n+1\nhttps://toolshub.example", "spam-wording-advisor": "Act now for a free guide", "subject-line-advisor": "Welcome to ToolsHUB", "base64-encode": "ToolsHUB", "base64-decode": "VG9vbHNIVUI=", "image-to-base64": "data:image/png;base64,ToolsHUB", "file-to-base64": "data:text/plain;base64,ToolsHUB", "file-to-text": "ToolsHUB local file", "pdf-metadata": "data:application/pdf;base64,JVBERi", "url-encode": "ToolsHUB works", "url-decode": "ToolsHUB%20works", "html-entity-encode": "<ToolsHUB>", "html-entity-decode": "&amp;ToolsHUB", rot13: "ToolsHUB", "morse-code": "ToolsHUB", "password-generator": "", "random-string": "12", "uuid-generator": "", "nanoid-generator": "", "random-number": "1 10", "number-sorter": "9 2 4", "average-calculator": "2 4", "binary-converter": "01000001", "decimal-converter": "10", "json-formatter": "{\"name\":\"ToolsHUB\"}", "json-minifier": "{\"name\": \"ToolsHUB\"}", "json-validator": "{\"name\":\"ToolsHUB\"}", "csv-converter": "name\nToolsHUB", "html-beautifier": "<main><p>ToolsHUB</p></main>", "css-minifier": "p { color: red; }", "regex-tester": "o\nToolsHUB", "email-validator": "hello@toolshub.example", "url-parser": "https://toolshub.example/tools", "query-string-parser": "?lang=bn", "json-escape": "ToolsHUB", calculator: "2+2", "percentage-calculator": "1 4", "hex-to-rgb": "#6D5DFB", "random-color": "", "invert-color": "#000000", "gradient-generator": "", "unix-timestamp": "0", "date-difference": "2026-01-01,2026-01-03", "file-size-converter": "2048", "file-type-identifier": "25504446", "fancy-text": "ToolsHUB", "coin-flipper": "", "dice-roller": "",
    };
